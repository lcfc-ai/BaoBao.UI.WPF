...
namespace BaoBao.UI.WPF.Controls
{
    ...
    public class BaoBaoPagination : Control
    {
        static BaoBaoPagination()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaoBaoPagination), new FrameworkPropertyMetadata(typeof(BaoBaoPagination)));
        }
        ...
        public static readonly DependencyProperty CurrentPageProperty =
            DependencyProperty.Register("CurrentPage", typeof(int), typeof(BaoBaoPagination), 
        ...
        public static readonly DependencyProperty TotalCountProperty =
            DependencyProperty.Register("TotalCount", typeof(int), typeof(BaoBaoPagination), new PropertyMetadata(0, OnTotalChanged));
        ...
        public static readonly DependencyProperty PageSizeProperty =
            DependencyProperty.Register("PageSize", typeof(int), typeof(BaoBaoPagination), 
        ...
        private static readonly DependencyPropertyKey TotalPagesPropertyKey =
            DependencyProperty.RegisterReadOnly("TotalPages", typeof(int), typeof(BaoBaoPagination), new PropertyMetadata(1));
        ...
        public static readonly RoutedEvent PageChangedEvent = EventManager.RegisterRoutedEvent(
            "PageChanged", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<int>), typeof(BaoBaoPagination));
        ...
        public static readonly RoutedEvent PageSizeChangedEvent = EventManager.RegisterRoutedEvent(
            "PageSizeChanged", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<int>), typeof(BaoBaoPagination));
        ...
        {
            var control = (BaoBaoPagination)d;
