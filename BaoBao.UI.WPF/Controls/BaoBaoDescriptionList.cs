...
{
    public class BaoBaoDescriptionList : ItemsControl
    {
        static BaoBaoDescriptionList()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaoBaoDescriptionList), new FrameworkPropertyMetadata(typeof(BaoBaoDescriptionList)));
        }
