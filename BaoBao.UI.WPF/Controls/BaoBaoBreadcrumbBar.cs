...
{
    public class BaoBaoBreadcrumbBar : ItemsControl
    {
        static BaoBaoBreadcrumbBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaoBaoBreadcrumbBar), new FrameworkPropertyMetadata(typeof(BaoBaoBreadcrumbBar)));
        }

        public static readonly DependencyProperty SeparatorProperty =
            DependencyProperty.Register("Separator", typeof(object), typeof(BaoBaoBreadcrumbBar), new PropertyMetadata(" / "));
