...
namespace BaoBao.UI.WPF.Controls
{
    ...
    public class BaoBaoCircleProgressBar : ProgressBar
    {
        ...
        static BaoBaoCircleProgressBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaoBaoCircleProgressBar), new FrameworkPropertyMetadata(typeof(BaoBaoCircleProgressBar)));
        }
        ...
        public static readonly DependencyProperty StrokeThicknessProperty =
            DependencyProperty.Register("StrokeThickness", typeof(double), typeof(BaoBaoCircleProgressBar), 
        ...
        public static readonly DependencyProperty IsPieProperty =
            DependencyProperty.Register("IsPie", typeof(bool), typeof(BaoBaoCircleProgressBar), 
                new PropertyMetadata(false, OnIsPieChanged));

        private static void OnStrokeThicknessChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((BaoBaoCircleProgressBar)d).UpdatePath();
        }
