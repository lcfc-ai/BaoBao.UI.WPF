...
{
    public class BaoBaoCodeExample : ContentControl
    {
        static BaoBaoCodeExample()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BaoBaoCodeExample), new FrameworkPropertyMetadata(typeof(BaoBaoCodeExample)));
        }

        public BaoBaoCodeExample()
        {
            Loaded += BaoBaoCodeExample_Loaded;
        }

        private void BaoBaoCodeExample_Loaded(object sender, RoutedEventArgs e)
        {
            UpdateCode();
        }

        public static readonly DependencyProperty HeaderProperty =
            DependencyProperty.Register("Header", typeof(string), typeof(BaoBaoCodeExample), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CodeProperty =
            DependencyProperty.Register("Code", typeof(string), typeof(BaoBaoCodeExample), new PropertyMetadata(null, OnCodeChanged));

        private static void OnCodeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is BaoBaoCodeExample control && !control._isInternalUpdate)
            {
