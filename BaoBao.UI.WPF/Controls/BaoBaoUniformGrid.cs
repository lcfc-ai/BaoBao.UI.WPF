...
namespace BaoBao.UI.WPF.Controls
{
    ...
    /// </summary>
    public class BaoBaoUniformGrid : UniformGrid
    {
        ...
        public static readonly DependencyProperty RowSpacingProperty =
            DependencyProperty.Register("RowSpacing", typeof(double), typeof(BaoBaoUniformGrid),
        ...
        public static readonly DependencyProperty ColumnSpacingProperty =
            DependencyProperty.Register("ColumnSpacing", typeof(double), typeof(BaoBaoUniformGrid),
                new FrameworkPropertyMetadata(5.0, FrameworkPropertyMetadataOptions.AffectsMeasure));
